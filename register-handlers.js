...
function buildPublicRegistrationEmbed(data, ownerId, slotNumber, group, scrimName, store, isSlotChange = false) {
  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      ...
      `<a:emoji_184:1545519214528434398> **Owner** — <@${ownerId}>\n` +
      `🔰 **Group** — ${groupDisplayName(group)}\n` +
      `<a:emoji_189:1545523471746990092> **Assigned Slot** — ${localSlotNumber(slotNumber)}\n` +
      `<:emoji_1759633286586:1538873940171038791> **Scrim** — ${scrimName}\n` +
...
async function handleManageMatchesButton(interaction) {
  ...
  const row = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      .setCustomId('register_Manage_slot')
