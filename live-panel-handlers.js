...
const {
  ...
  nextOpenGroupLetters, dayBatchForLetter, dayLabelForBatch, isGroupClosed, groupTimeSummary,
  formatDDMMYYYY,
...
function buildLiveGroupsPanel(store) {
  ...
  for (const letter of letters) {
    ...
    embed.addFields({
      name: `${fillCircle(filled, capacity)} ${groupDisplayName(letter)} — ${groupTimeSummary(letter, store)} (${groupDate})`,
