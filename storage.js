...
function defaultPointTable() {
  return {
    ...
    design: { serverName: null, instagram: null, discordInvite: null, youtube: null },
  };
}
...
//       design: { serverName, instagram, discordInvite, youtube } }
//   }
// }
...
function getGuildStore(guildId) {
  ...
  if (all[guildId].pointTable.design === undefined) all[guildId].pointTable.design = { serverName: null, instagram: null, discordInvite: null, youtube: null };
  return all[guildId];
}
