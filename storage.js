...
function getGuildStore(guildId) {
  const all = loadAll();
  if (!all[guildId]) {
    all[guildId] = { scrim: null, tournament: null, warnings: {}, verifications: {}, teams: {}, settings: {}, embeds: {} };
    saveAll(all);
  }
...
module.exports = { getGuildStore, saveGuildStore, getDmThread, setDmThread };
