...
function buildVerifiedLogEmbed(data, teamNumber, ownerId, isEdit) {
  ...
  return new EmbedBuilder()
    .setTitle(isEdit ? '<:emoji_7:1543558072046194718> TEAM VERIFICATION — Team Updated' : '🏆 TEAM VERIFICATION — Team Confirmed')
...
async function handleVerifyStep3Submit(interaction) {
  ...
  // skipped, refuse to continue with a half-filled verification.
