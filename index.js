...
const {
  handleRegisterTeamButton, handleUseOldTeam, handleEditTeam, handleChangeSlotButton,
...
const {
  handleScrimWizardButton, handleScrimCreateModalSubmit, handleScrimEditModalSubmit,
} = require('./scrim-wizard-handlers');
const { handleLivePanelPageButton } = require('./live-panel-handlers');
const {
...
client.on('interactionCreate', async (interaction) => {
  ...
  try {
    if (interaction.isChatInputCommand()) {
      ...
      } else if (interaction.customId.startsWith('live_panel_page_')) {
        await handleLivePanelPageButton(interaction);
