...
const { handlePointTableButton, handlePointTableModalSubmit, handlePointTableSelectMenu } = require('./point-table-handlers');
...
client.on('interactionCreate', async (interaction) => {
  ...
  try {
    if (interaction.isChatInputCommand()) {
      ...
      } else if (interaction.customId.startsWith('pt_')) {
        await handlePointTableButton(interaction);
      }
      ...
      if (interaction.customId === 'verify_select_players') {
        ...
        await handlePointTableSelectMenu(interaction);
      }
      ...
      else if (interaction.customId.startsWith('pt_')) await handlePointTableModalSubmit(interaction);
    }
  } catch (err) {
