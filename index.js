...
const { handlePtButton, handlePtModalSubmit } = require('./pt-handlers');
  ...
  try {
    if (interaction.isChatInputCommand()) {
      ...
      if (interaction.customId === 'scrim_register_start') {
        ...
        await handlePtButton(interaction);
      }
      ...
      else if (interaction.customId.startsWith('pt_')) await handlePtModalSubmit(interaction);
    }
  } catch (err) {
