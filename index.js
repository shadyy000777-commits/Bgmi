...
const {
  handleRegisterTeamButton, handleUseOldTeam, handleEditTeam, handleEditTeamDirectButton, handleNewTeam,
...
client.on('interactionCreate', async (interaction) => {
  ...
  try {
    if (interaction.isChatInputCommand()) {
      ...
      } else if (interaction.customId === 'register_team_edit_direct') {
        await handleEditTeamDirectButton(interaction);
